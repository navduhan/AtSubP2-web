    ...
    <header className="bg-[#00263A] text-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link
            href="/"
            className="text-2xl font-extrabold italic tracking-tight text-white hover:text-[#2ec0c4] transition-colors"
          >
            AtSubP 2.0
          </Link>
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-1.5 border-b-2 py-1 text-sm font-semibold transition-all sm:text-base ${
                    isActive
                      ? 'text-[#2ec0c4] border-[#2ec0c4]'
                      : 'text-white border-transparent hover:text-[#2ec0c4]'
                  }`}
                >
