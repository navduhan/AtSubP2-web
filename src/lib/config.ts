...
export const PREDICTION_CONFIG = {
  ...
  jobDir: process.env.PREDICTION_JOB_DIR || path.join(os.tmpdir(), 'atsubp2-jobs'),
  ...
  local: {
    ...
    cliPath: process.env.LOCAL_CLI_PATH || '/opt/predictor/AtSubP2.py',
    kerasHome: process.env.LOCAL_KERAS_HOME || '/tmp/atsubp2-keras',
  },
};
